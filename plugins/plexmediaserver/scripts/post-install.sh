...
chmod 555 "${plexmediaserver_pbi_path}/share/plexmediaserver/Plex DLNA Server" \
	...
	"${plexmediaserver_pbi_path}/share/plexmediaserver/Resources/Plex Relay" \
	"${plexmediaserver_pbi_path}/share/plexmediaserver/Resources/Plex Script Host" \
	"${plexmediaserver_pbi_path}/share/plexmediaserver/Resources/Plex Transcoder"
